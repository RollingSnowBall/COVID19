...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.fetchCovidOverview(completionHandler: { [weak self] result in
            ...
            case let .success(result):
                ...
                let covidOverview = self.makeCovidOverviewList(cityCovidOverview: result)
                self.configChartView(covidOverviewList: covidOverview)
    ...
    func configChartView(covidOverviewList: [CovidOverview]){
        ...
        self.pieChartView.spin(duration: 0.3, fromAngle: self.pieChartView.rotationAngle, toAngle: self.pieChartView.rotationAngle + 130)
    }
